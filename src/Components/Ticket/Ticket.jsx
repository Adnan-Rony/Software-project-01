...
const Ticket = () => {
    ...
    return (
        <div className='container mx-auto p-24 pb-20'>
            ...
            <div className="grid lg:grid-cols-3 grid-cols-1 mx-auto mt-5">

<div className="border  rounded-xl bg-white w-[330px] h-[552px]">
  <div className="flex justify-center">
    <h1 className="text-center bg-[#df42b1] w-1/2 rounded-xl p-3 text-white font-bold">1 DAY PASS</h1>
  </div>
  <img className="mx-auto mt-4" src="./images/p1.png.webp" alt=""/>
  <h1 className="text-center font-bold text-4xl">500 Tk</h1>
  <div className="flex justify-center mt-5">
    <button onClick={handleticket} className="w-3/4 mx-auto btn  btn-secondary hover:bg-gray-500">GET TICKETS -</button>
  </div>
...
<div className="border  rounded-xl bg-white w-[330px] h-[552px]">
  <div className="flex justify-center">
    <h1 className="text-center bg-[#df42b1] w-1/2 rounded-xl p-3 text-white font-bold">FULL PASS</h1>
  </div>
  <img className="mx-auto mt-4" src="./images/p2.png.webp" alt=""/>
  <h1 className="text-center font-bold text-4xl">1000 Tk</h1>
  <div className="flex justify-center mt-5">
    <button onClick={handleticket} className="w-3/4 mx-auto btn btn btn-secondary hover:bg-gray-500">GET TICKETS -</button>
  </div>
  <div className="space-y-3 mt-4">
...
<div className="border  rounded-xl bg-white w-[330px] h-[552px]">
  <div className="flex justify-center">
    <h1 className="text-center bg-[#df42b1] w-1/2 rounded-xl p-3 text-white font-bold">GROUP PASS</h1>
  </div>
